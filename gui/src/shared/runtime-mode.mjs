...
export function applicationInfo(version,mode){
  return Object.freeze({version,mode,author:'TREe191',github:'https://github.com/TREe191/forest-scholar-skin',developerControls:mode==='development',supportDiagnostics:mode==='beta'||mode==='development'});
}
